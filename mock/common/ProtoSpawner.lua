...
function ProtoSpawner:setProto( proto )
	self.proto = proto
end

function ProtoSpawner:spawnFromProto( proto, ox, oy, oz )
end
...
function ProtoSpawner:spawnOne( ox, oy, oz )
	...
	if self.spawnCallback then self.spawnCallback( self, instance ) end
	return instance
end
