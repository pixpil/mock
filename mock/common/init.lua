...
require 'mock.common.RawDataAsset'
require 'mock.common.DataAsset'
require 'mock.common.DataSheetAsset'
require 'mock.common.AssetMap'
require 'mock.common.AssetList'

require 'mock.common.CurveAsset'
...
--------------------------------------------------------------------
-- BASE
require 'mock.common.Behaviour'
require 'mock.common.UpdateListener'
require 'mock.common.IntervalUpdateListener'

require 'mock.common.ColorLink'
require 'mock.common.TransformLink'
require 'mock.common.TransformShear'
require 'mock.common.VisualLink'
...
--------------------------------------------------------------------
require 'mock.common.InputListener'
require 'mock.common.InputScript'
...
require 'mock.common.LinePathFollower'
...
require 'mock.common.LocaleConditionalGroup'
require 'mock.common.LocaleVisibility'
