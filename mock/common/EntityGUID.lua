...
local function affirmSceneIndexGUID( scene )
	if not scene.__guid then
		scene.__guid = generateGUID()
	end
end
...
_M.affirmSceneIndexGUID = affirmSceneIndexGUID
